...
public class RecimgView extends AppCompatImageView {

    //圆角大小，默认为10
    private int mBorderRadius = 500;
    ...
    public RecimgView(Context context) {
        this(context, null);
    }

    public RecimgView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }
    RecimgView(Context context, AttributeSet attrs, int defStyleAttr) {
